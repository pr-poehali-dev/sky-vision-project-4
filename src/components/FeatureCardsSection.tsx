          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Мы поставляем насосы, задвижки и трубопроводную арматуру для объектов любой сложности:
                надёжное оборудование, сертифицированное по российским стандартам.{" "}
