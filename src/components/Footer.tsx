export function Footer() {
  const footerLinks = {
    "Каталог": ["Насосы центробежные", "Насосы погружные", "Задвижки клиновые", "Задвижки шиберные", "Арматура трубопроводная", "Фитинги и фланцы"],
    "Покупателям": ["Как заказать", "Доставка и оплата", "Возврат", "Гарантия", "Документация", "Сертификаты"],
    "Компания": ["О нас", "Клиенты", "Партнёрам", "Новости", "Вакансии", "Качество"],
    "Отрасли": ["Водоснабжение", "Нефть и газ", "Химическая промышленность", "ЖКХ", "Энергетика"],
    "Контакты": ["Позвонить", "Написать нам", "Telegram", "WhatsApp", "Адрес склада"],
  }
